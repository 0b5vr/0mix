...
import { assign, build, defInNamed, defOut, div, insert, main, smoothstep, sw, vec3, vec4 } from '../../../../shaders/shaderBuilder';
...
export const pillarGridFrameFrag = build( () => {
  ...
  main( () => {
    ...
    assign( fragColor, vec4( vec3( smoothstep( 0.7, 1.0, vH ) ), 1.0 ) );
